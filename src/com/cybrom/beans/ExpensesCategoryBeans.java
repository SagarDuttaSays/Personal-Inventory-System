...
public class ExpensesCategoryBeans {
   private int exp_catid, userid;
   private String exp_catname, exp_catdetails;
   
   public ExpensesCategoryBeans() {
    }

    public ExpensesCategoryBeans(int exp_catid, String exp_catname, String exp_catdetails, int userid) {
